...
const MostBuyCard = (props) => {
  const {listProduct, navigation} = props;
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        {listProduct.map((result, idx) => (
          <View style={mostBuyStyle.cardOuter} key={idx}>
            <TouchableOpacity onPress={() => navigation.navigate("DetailItem")} style={{...mostBuyStyle.cardInner, backgroundColor: result.backgroundColor}}>
